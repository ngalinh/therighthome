...
>(({ className, children, onOpenAutoFocus, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      // the dialog opens. On iOS PWA, that element is often <input type="date">
      // and programmatic focus there auto-pops the native date picker — which
      // appears immediately on every dialog open. Focus trap still works via
      // Tab/Shift+Tab; users tap to focus an input. Callers can opt back in
      // by passing their own onOpenAutoFocus handler.
      onOpenAutoFocus={(e) => {
